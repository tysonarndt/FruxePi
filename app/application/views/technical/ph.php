        ...
        <section class="pt-3 pb-5">
            <div class="card">
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-8">
                            <h1 class="card-header-title align-middle">Technical &#187; pH Probe</h1>
                        </div>
                ...
                <div id="sensor-settings" class="card-body">
                    ...
                    <!-- Set GPIO Pin -->
                    <?php echo form_open("technical/ph/edit/GPIO"); ?>
    ...
    <script>
        ...
        $('#sensor-toggle').change(function() {
            if (this.checked) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '../technical/ph/enable'
                });
            } else {
                $('#sensor-settings').addClass("settings-disabled");
                $.ajax({
                    type: 'POST',
                    url: '../technical/ph/disable'
                });
            }
        });
        ...
        function runDiagnostics() {
            $('#diagnosticsMsg').load("<?php echo base_url('technical/ph/diagnostics') ?>");
